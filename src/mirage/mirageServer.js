              ...
              elements: [
                {
                  code: 1211,
                  name: 'Issyk-Kul',
                  imageUrl: '/images/cities/issyk-kul.jpg'
                },
                {
                  code: 1212,
                  name: 'Cholpon-Ata',
                  imageUrl: '/images/cities/cholpon-ata.jpg'
                },
                {
                  code: 1213,
                  name: 'Karakol',
                  imageUrl: '/images/cities/karakol.jpg'
                },
                {
                  code: 1214,
                  name: 'Chunkurchak',
                  imageUrl: '/images/cities/chunkurchak.jpg'
                },
                {
                  code: 1215,
                  name: 'Bishkek',
                  imageUrl: '/images/cities/bishkek.jpg'
                }
              ],
            },
          }
      ...
      this.get('/availableCities', () => {
        return new Response(
          ...
          {},
          {
            errors: [],
            data: {
              elements: ['issyk-kul', 'bishkek', 'karakol'],
            },
          }
        );
      });
